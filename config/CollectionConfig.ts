...
const CollectionConfig: CollectionConfigInterface = {
  ...
  contractName: 'DeixaXastrosCollection',
  tokenName: 'DeixaXastros',
  tokenSymbol: 'XASTROS',
  hiddenMetadataUri: 'ipfs://QmPSsZraxSBSk9eYdUQzVXozJQdw8ztG2KmvMuNzeSG6J9/xastros_presale.json',
  maxSupply: 30,
  freelistSale: {
    price: 0.00,
    mintLimit: 5,
  ...
  stakingContractName: "DeixaXastrosStaking",
